...
function ProductList({ onHomeClick }) {
    ...
    const isInCart = (plantName) => {
        return cartItems.some(item => item.name === plantName); // ✅ Helper to check cart status
    };
    ...
    return (
        <div>
            <div className="navbar">
                ...
                <div className="nav-links"  style={styleObjUl}>
            ...
            {!showCart ? (
                <div className="product-grid">
                    {showPlants && plantsArray.map((categoryData, idx) => (
